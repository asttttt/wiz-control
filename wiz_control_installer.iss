...
; 3. Done so end users DO NOT need Python installed
; 4. User Bulb or light IPs are saved to %APPDATA%\WizControl\wiz_slots.json AFTER installation
...
#define AppPublisher "WizControl"
#define AppExeName   "WizControl.exe"
#define AppURL       "https://github.com/YOUR_USERNAME/wiz-control"
